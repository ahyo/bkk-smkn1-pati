/* Dibangkitkan oleh scripts/build_demo_icons.py — jangan disunting manual.
   Sumber: app/icons.py */
(function (global) {
  "use strict";
  ...
  "factory": "<path d=\"M3 21V10.5l6 3.5v-3.5l6 3.5V6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v15Z\"/><path d=\"M7 21v-3M12 21v-3M17 21v-3\"/>",
  ...
  "key": "<circle cx=\"7.5\" cy=\"12\" r=\"4\"/><path d=\"M11.5 12H21\"/><path d=\"M17.5 12v3.5\"/><path d=\"M20.5 12v2.5\"/>",
  ...
  "verified": "<path d=\"m12 2 2.4 1.8 3-.3 1 2.8 2.6 1.5-.9 2.9.9 2.9-2.6 1.5-1 2.8-3-.3L12 22l-2.4-1.8-3 .3-1-2.8L3 16.2l.9-2.9L3 10.4l2.6-1.5 1-2.8 3 .3Z\" fill=\"currentColor\" stroke=\"none\"/><path d=\"m8.6 12.2 2.3 2.3 4.5-4.8\" stroke=\"#fff\" stroke-width=\"2\"/>",
  "alert": "<circle cx=\"12\" cy=\"12\" r=\"9\"/><path d=\"M12 7.5v5.5\"/><path d=\"M12 16.5h.01\"/>",
  "warning": "<path d=\"M10.3 3.9 1.9 18a2 2 0 0 0 1.7 3h16.8a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z\"/><path d=\"M12 9v4.5\"/><path d=\"M12 17.5h.01\"/>",
  ...
  "file": "<path d=\"M14 2.5H6.5a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V8Z\"/><path d=\"M14 2.5V8h5.5\"/><path d=\"M9 13.5h6M9 17h4\"/>",
  "clipboard": "<path d=\"M9 4H7a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2\"/><rect x=\"9\" y=\"2.5\" width=\"6\" height=\"4\" rx=\"1\"/><path d=\"M9 12h6M9 16h4\"/>",
  "inbox": "<path d=\"M22 12.5h-5.5l-1.5 3h-6l-1.5-3H2\"/><path d=\"M5.6 5.2 2 12.5V18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.5l-3.6-7.3A2 2 0 0 0 16.6 4H7.4a2 2 0 0 0-1.8 1.2Z\"/>",
  ...
  "rocket": "<path d=\"M5 13c-1.5 1.3-2 5.5-2 5.5s4.2-.5 5.5-2\"/><path d=\"M12.5 18.5 9 15l-3.5-3.5C9 5.5 14 3 19.5 3.5 20 9 17.5 14 12.5 18.5Z\"/><circle cx=\"14.5\" cy=\"8.5\" r=\"1.8\"/>",
  ...
  var SIZES = {"xs": 13, "sm": 15, "md": 17, "lg": 20, "xl": 24, "2xl": 34, "3xl": 44};
